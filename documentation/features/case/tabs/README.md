...
Access to the case tabs can be configured through access control. More information about access control can be found in the [access control documentation](../../access-control/README.md).
