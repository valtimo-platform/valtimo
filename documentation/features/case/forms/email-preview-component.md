...
<figure><img src="../../../.gitbook/assets/email-preview-component-rendered.png" alt="A rendered e-mail preview on a form"><figcaption><p>A rendered e-mail preview on a form</p></figcaption></figure>
...
{% stepper %}
{% step %}
Navigate to **Admin** → **Forms** and open (or create) the form.
{% endstep %}
{% step %}
In the form builder, expand the **Advanced** group in the component palette and drag
**E-mail preview** onto the form.

<figure><img src="../../../.gitbook/assets/email-preview-component-builder.png" alt="The E-mail preview component in the form builder"><figcaption><p>The E-mail preview component in the form builder</p></figcaption></figure>
{% endstep %}
{% step %}
...
<figure><img src="../../../.gitbook/assets/email-preview-component-settings.png" alt="The E-mail preview component settings"><figcaption><p>The E-mail preview component settings</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/email-preview-component-dark-mode.png" alt="The e-mail preview in dark mode"><figcaption><p>The e-mail preview in dark mode</p></figcaption></figure>

## Related

* [Forms](README.md)
* [Prefilling data](creating-forms-in-valtimo.md)
* [Interpolating data](interpolating-data-in-formio.md)
