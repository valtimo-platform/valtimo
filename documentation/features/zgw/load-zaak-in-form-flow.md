...
{% hint style="success" %}
Available since Valtimo `12.38.0`
{% endhint %}

Valtimo provides a [form flow](../forms/form-flow.md) bean to load a zaak from the Zaken API. The bean returns the full zaak, so the implementer can use whatever information is relevant for their flow.
