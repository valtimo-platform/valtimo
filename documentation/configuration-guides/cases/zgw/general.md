...
4. Click the **ZGW** tab, then the **General** sub-tab

![General sub-tab with its four tiles](../../../assets/configuration-guides/cases/zgw/general/01-tiles-overview.png)
...
1. On the **Connected zaak type** tile, click **Link zaak type** (or **Edit** if a zaak type is already connected)
2. Fill in the zaak type details:

![Connect zaak type modal](../../../assets/configuration-guides/cases/zgw/general/02-connected-zaaktype-modal.png)
...
1. On the **Zaak detail synchronisation** tile, click **Configure case detail synchronisation**
2. Select an **Object management configuration** and enable synchronisation:

![Add case detail synchronisation modal](../../../assets/configuration-guides/cases/zgw/general/03-case-detail-sync-modal.png)
...
1. On the **Zaak synchronisation** tile, click **Configure zaak synchronisation**
2. Configure which case data synchronizes to the zaak:
