...
2. Click on a building block to configure it, or click **Create** to add a new one
...
Each building block has a version tag (e.g., `1.0.0`). The version selector in the page header shows the current version. Building blocks are immutable once created; to make changes, create a new version.
