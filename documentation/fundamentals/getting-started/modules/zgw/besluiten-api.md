...
Before the Besluiten API plugin can be used, an authentication plugin is needed. One such authentication plugin is the OpenZaak plugin. Instructions on how to add the OpenZaak plugin can be found in the [OpenZaak plugin configuration guide](../../../../features/plugins/configure-openzaak-plugin.md).
