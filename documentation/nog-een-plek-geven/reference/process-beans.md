...
This process bean contains functions for accessing the Valtimo value resolver. More information [here](../../fundamentals/getting-started/modules/core/value-resolver.md)
