...
Sonatype Central (Maven Central). Publishing to Sonatype Central stops on **30 September 2026**;
...
3. After 30 September 2026, remove the old `s01.oss.sonatype.org` repositories if you no longer
   need them.
