...
More details can be found in the [widgets documentation](../../../features/case/case-detail/tabs/widgets.md)
...
More details can be found in the [Zaken API plugin documentation](../../../features/plugins/configure-zaken-api-plugin.md)
