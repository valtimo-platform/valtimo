...
@Component({
  standalone: true,
  selector: 'valtimo-bb-migration-data-migration-tab',
...
export class BbMigrationDataMigrationTabComponent implements OnInit, OnDestroy {
  ...
  // Source copies from building block document data; the target must be a writable document path.
