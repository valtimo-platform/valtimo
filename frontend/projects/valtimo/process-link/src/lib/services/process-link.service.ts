...
export class ProcessLinkService {
  ...
  public deleteAutofill(processDefinitionId: string, activityId: string): Observable<void> {
    return this.http.delete<void>(
      `${this.VALTIMO_ENDPOINT_URI}management/v1/process-definition/${processDefinitionId}/autofill/${activityId}`
    );
  }
}
