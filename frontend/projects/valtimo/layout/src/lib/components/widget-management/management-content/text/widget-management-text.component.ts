...
import {WidgetColor, WidgetColorTile, WidgetTextContent} from '../../../../models';
import {
  WIDGET_COLOR_ITEMS,
...
@Component({
  templateUrl: './widget-management-text.component.html',
  styleUrl: './widget-management-text.component.scss',
...
export class WidgetManagementTextComponent implements OnInit, OnDestroy {
  @HostBinding('class') public readonly class = 'valtimo-widget-management-text';
  ...
  public readonly form = this.fb.group({
    ...
    content: this.fb.control(
      (this.widgetWizardService.$widgetContent() as WidgetTextContent)?.content ?? '',
      Validators.required
    ),
  });
  ...
  public ngOnInit(): void {
    if (!this.widgetWizardService.$widgetColor()) {
      this.widgetWizardService.$widgetColor.set(WidgetColor.WHITE);
    }
