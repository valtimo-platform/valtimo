...
/**
 * A group of conditions, combined with AND (`allOf`) or OR (`anyOf`). Exactly one of the two keys is
 * present — the key itself carries the meaning, matching the backend JSON.
 */
