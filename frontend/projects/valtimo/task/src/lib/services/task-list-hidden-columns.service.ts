...
@Injectable()
export class TaskListHiddenColumnsService extends BaseApiService {
  constructor(
  ...
  public getHiddenColumns(caseDefinitionName: string): Observable<ListField[]> {
    return this.httpClient.get<ListField[]>(
      this.getApiUrl(`v1/case/${caseDefinitionName}/hidden-task-list-column`)
    );
  }
