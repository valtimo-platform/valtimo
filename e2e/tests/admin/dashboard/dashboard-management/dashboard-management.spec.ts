...
test.describe('Dashboard management', () => {
  ...
  test.describe('Success scenarios', () => {
    test('10.2 — Create a new dashboard', async () => {
    ...
    test('10.1 — View dashboard list shows created dashboard', async () => {
      const row = dashboardPage.carbonList.row(TEST_TITLE);
      await row.assertVisible();
    ...
    test('10.4 — View dashboard metadata on detail page', async () => {
      const row = dashboardPage.carbonList.row(TEST_TITLE);
      await row.click();
    ...
    test('10.3 — Edit dashboard title and description', async () => {
    ...
    test('10.5 — Toggle between JSON and visual editor', async () => {
    ...
    test('10.6 — Edit dashboard JSON', async () => {
      await dashboardPage.switchToJsonEditor();
...
test.describe('Dashboard management — Widget management', () => {
  ...
  test.describe('View widgets list', () => {
    test('10.7 — Widget list is visible', async () => {
  ...
  test.describe('Add new widget', () => {
    test('10.8 — Add widget with case-count data source and big-number display', async () => {
  ...
  test.describe('Edit widget configuration', () => {
    test('10.11 — Edit widget title via row click', async () => {
  ...
  test.describe('Rearrange widgets via drag and drop', () => {
    ...
    test('10.9 — Reorder widgets via drag and drop', async ({}, testInfo) => {
  ...
  test.describe('Delete widget', () => {
    test('10.10 — Delete widget via overflow menu', async () => {
  ...
  test.describe('Widget configuration form', () => {
    ...
    test('10.13 — Enter widget title', async () => {
    ...
    test('10.14 — Select data source', async () => {
    ...
    test('10.15 — Select case type', async () => {
    ...
    test('10.12 — Select widget display type', async () => {
    ...
    test('10.18 — Configure condition operator', async () => {
    ...
    test('10.19 — Configure condition value', async () => {
    ...
    test('10.20 — Use placeholders in conditions', async () => {
      const row = dashboardPage.conditionRow(0);
      const input = row.getByTestId('valuePathSelectorDropdownValueValueInput');
      await input.clear();
    ...
    test('10.21 — Select display type', async () => {
      // Big number was selected in a prior test — verify it's still selected
      await expect(dashboardPage.widgetDisplayTypeDropdown).toContainText('Big number');
    });

    test('10.22 — Configure display type title', async () => {
    ...
    test('10.23 — Configure display subtitle', async () => {
    ...
    test('10.24 — Configure display label', async () => {
    ...
    test('10.25 — Toggle KPI usage', async () => {
  ...
  test.describe('Widget data source configuration', () => {
    ...
    test('10.27 — Configure case count widget', async () => {
      await dashboardPage.openAddWidgetModal();
    ...
    test('10.28 — Configure multiple counts widget', async () => {
      await dashboardPage.openAddWidgetModal();
    ...
    test('10.29 — Configure group by widget', async () => {
      await dashboardPage.openAddWidgetModal();
    ...
    test('10.30 — Configure task count widget', async () => {
      await dashboardPage.openAddWidgetModal();
