...
package com.ritense.localization.endpoint
...
@SkipComponentScan
class LocalizationEndpointDescriptionProvider : EndpointDescriptionProvider {

    override fun getEndpointDescriptors(): List<EndpointDescriptor> = listOf(
        endpoint("PUT", "/api/management/v1/localization/{languageKey}", "Update localization for language", "Vertaling voor taal bijwerken"),
        endpoint("PUT", "/api/management/v1/localization", "Update localizations", "Vertalingen bijwerken"),
    )
