...
@AllOpen
@Entity
@DiscriminatorValue("metroline")
class MetrolineWidget(
    ...
    val properties: MetrolineWidgetProperties,
) : Widget(
    ...
    override fun toDto() = MetrolineWidgetDto(
        key = this.key,
        title = this.title,
        icon = this.icon,
        color = this.color,
    ...
    override fun getUnresolvedValues(): List<String> = super.getUnresolvedValues() + properties.source
}
