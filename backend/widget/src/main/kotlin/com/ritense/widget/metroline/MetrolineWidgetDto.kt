...
@JsonTypeName("metroline")
data class MetrolineWidgetDto(
    ...
    @field:Valid val properties: MetrolineWidgetProperties,
) : WidgetDto {
    override fun toEntity(id: UUID, order: Int): Widget = MetrolineWidget(
        id = id,
        key = key,
        title = title,
        icon = icon,
