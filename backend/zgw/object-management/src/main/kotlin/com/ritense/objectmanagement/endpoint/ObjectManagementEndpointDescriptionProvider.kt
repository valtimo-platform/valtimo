...
package com.ritense.objectmanagement.endpoint
...
@SkipComponentScan
class ObjectManagementEndpointDescriptionProvider : EndpointDescriptionProvider {

    override fun getEndpointDescriptors(): List<EndpointDescriptor> = listOf(
        endpoint("GET", "/api/management/v1/object/management/configuration", "List object management configurations", "Objectbeheerconfiguraties ophalen"),
    )
