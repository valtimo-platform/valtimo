...
class ZgwDocumentToJsonSchemaDocumentMapper(
    private val documentRepository: JsonSchemaDocumentRepository
) : AuthorizationEntityMapper<ZgwDocument, JsonSchemaDocument> {
    ...
    override fun mapQuery(
        root: Root<ZgwDocument>,
        query: AbstractQuery<*>,
        criteriaBuilder: CriteriaBuilder,
    ): AuthorizationEntityMapperResult<JsonSchemaDocument> {
        throw UnsupportedOperationException("Mapping query for ZgwDocument to JsonSchemaDocument is not supported")
    }

    override fun supports(fromClass: Class<*>, toClass: Class<*>): Boolean {
        return fromClass == ZgwDocument::class.java && toClass == JsonSchemaDocument::class.java
    }
}
