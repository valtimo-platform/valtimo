...
class DocumentObjectenApiSyncConfigurationIssueListenerTest {

    lateinit var applicationEventPublisher: ApplicationEventPublisher
    lateinit var listener: DocumentObjectenApiSyncConfigurationIssueListener
    ...
    fun setUp() {
        ...
        listener = DocumentObjectenApiSyncConfigurationIssueListener(applicationEventPublisher)
    }

    @Test
    fun `handleSyncSaved should publish CaseConfigurationIssueResolvedEvent`() {
        listener.handleSyncSaved(DocumentObjectenApiSyncSavedEvent(caseDefinitionId))
        ...
        assertThat(captor.firstValue.issueType).isEqualTo(DocumentObjectenApiSyncImporter.ISSUE_TYPE)
    }
}
