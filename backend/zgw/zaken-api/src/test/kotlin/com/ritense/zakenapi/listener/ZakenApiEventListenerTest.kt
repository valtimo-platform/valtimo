...
class ZakenApiEventListenerTest {
    ...
    fun `should create zaak on DocumentCreatedEvent when zakenApiPluginConfigurationId is set`() {
        ...
        verify(zakenApiPlugin).createZaak(
            ...
            rsin = any(),
            zaaktypeUrl = any(),
            archiveActionDate = anyOrNull(),
            archiveNomination = anyOrNull(),
            archiveStatus = anyOrNull(),
            caseGeometry = anyOrNull(),
            characteristics = anyOrNull(),
            commissioningOrganisation = anyOrNull(),
            communicationChannel = anyOrNull(),
            communicationChannelName = anyOrNull(),
            confidentiality = anyOrNull(),
            description = anyOrNull(),
            explanation = anyOrNull(),
            finalDeliveryDate = anyOrNull(),
            identification = anyOrNull(),
            lastOpenedDate = anyOrNull(),
            lastPaymentDate = anyOrNull(),
            mainCase = anyOrNull(),
            suspension = anyOrNull(),
            paymentIndication = anyOrNull(),
            plannedEndDate = anyOrNull(),
            processObject = anyOrNull(),
            processObjectCategory = anyOrNull(),
            productsAndServices = anyOrNull(),
            publicationDate = anyOrNull(),
            registrationDate = anyOrNull(),
            relatedCases = anyOrNull(),
            relevantOtherCases = anyOrNull(),
            selectionListClass = anyOrNull(),
            startDateRetentionPeriod = anyOrNull(),
            extension = anyOrNull(),
        )
    }
