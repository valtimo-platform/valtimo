...
internal class ZaakServiceTest {
    ...
    @Test
    fun `should return zaak when a single authorized zaak is found`() {
        ...
        val result = zaakService.getZaakByIdentificatie("ZAAK-001", pluginId)
    ...
    fun `should filter unauthorized zaken`() {
        ...
        assertEquals(authorizedZaak, result)
    }
    ...
    fun `should throw when no authorized zaak found`() {
        ...
        assertThrows<ZaakNotFoundException> {
            zaakService.getZaakByIdentificatie("ZAAK-001", pluginId)
        }
    }
    ...
    fun `should search across all plugin configurations when no plugin id specified`() {
        ...
        val result = zaakService.getZaakByIdentificatie("ZAAK-001", null)
    ...
    fun `should throw when no plugin configurations found`() {
        ...
        val exception = assertThrows<IllegalStateException> {
            zaakService.getZaakByIdentificatie("ZAAK-001", null)
        }
