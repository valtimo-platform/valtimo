...
@Transactional
@SkipComponentScan
class DocumentZakenApiSyncCaseEventListener(
    private val service: DocumentZakenApiSyncManagementService,
) {
    ...
    fun handleCaseDefinitionPreDeleteEvent(event: CaseDefinitionPreDeleteEvent) {
        service.deleteSyncConfigurationByCaseDefinition(event.caseDefinitionId)
    }
}
