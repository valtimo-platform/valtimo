...
data class BuildingBlockDefinitionId(
...
) : AbstractId<BuildingBlockDefinitionId>(), VersionedIdentifier {
    ...
    init {
        ...
        require(key.matches(Regex("^[a-zA-Z0-9\\-]+$"))) {
            "[buildingBlockId.key] contains characters that are not allowed (only alphanumeric characters and dashes)"
        }
    }
