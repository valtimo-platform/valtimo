...
@Component
@SkipComponentScan
class ProcessLinkMessageStartEventStartListener(
    ...
    @EventListener(
        condition = """#event.delegateExecution.bpmnModelElementInstance != null
            ...
            && !#event.delegateExecution.bpmnModelElementInstance.getChildElementsByType(T(org.operaton.bpm.model.bpmn.instance.MessageEventDefinition)).isEmpty()
