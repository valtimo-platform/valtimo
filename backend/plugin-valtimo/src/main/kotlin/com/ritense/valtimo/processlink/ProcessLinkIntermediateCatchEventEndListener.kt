...
@Component
@SkipComponentScan
class ProcessLinkIntermediateCatchEventEndListener(
    ...
    @EventListener(
        condition = """#event.delegateExecution.bpmnModelElementInstance != null
            && #event.delegateExecution.bpmnModelElementInstance.elementType.typeName == T(org.operaton.bpm.engine.ActivityTypes).INTERMEDIATE_EVENT_CATCH
