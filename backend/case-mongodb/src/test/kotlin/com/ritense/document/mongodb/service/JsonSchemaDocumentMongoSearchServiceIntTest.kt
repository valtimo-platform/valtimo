...
import com.ritense.document.mongodb.BaseMongoIntegrationTest
...
@WithMockUser(username = BaseMongoIntegrationTest.USERNAME, authorities = [BaseMongoIntegrationTest.FULL_ACCESS_ROLE])
class JsonSchemaDocumentMongoSearchServiceIntTest : BaseMongoIntegrationTest() {
    ...
    private fun seedDocument(street: String): JsonSchemaDocument {
        ...
        mongoRepository.save(
            JsonSchemaDocumentDocument(
                ...
                content = content as ObjectNode,
                definitionId = objectMapper.readTree(
                    """{"name":"house","blueprintId":{"blueprintType":"CASE"}}"""
                ),
                createdOn = null,
                modifiedOn = null,
                createdBy = null,
