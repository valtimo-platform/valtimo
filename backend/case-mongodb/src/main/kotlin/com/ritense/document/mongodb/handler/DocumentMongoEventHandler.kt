...
package com.ritense.document.mongodb.handler
...
/**
 * Listens to document domain events from the Valtimo inbox and keeps the MongoDB read
 ...
 */
class DocumentMongoEventHandler(
    private val syncService: DocumentMongoSyncService,
) : ValtimoEventHandler {
