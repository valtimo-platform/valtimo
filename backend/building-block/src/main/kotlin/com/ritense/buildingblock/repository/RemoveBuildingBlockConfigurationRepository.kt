...
interface RemoveBuildingBlockConfigurationRepository :
    ...
    /** Deletes the stored component without reading it — every other route loads the row first, and loading deserialises its JSON. That is what kept a redeploy failing once `buildingBlockVersionTag` became required (§6.10). */
