...
/**
 * Resolves a building block definition version's process definitions via the
 * building block ↔ process-definition link. Contributes the `BUILDING_BLOCK` side to the
 * (type-agnostic) process migration suggester.
 */
