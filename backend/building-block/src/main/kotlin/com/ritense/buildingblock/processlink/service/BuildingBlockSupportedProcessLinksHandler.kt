...
@Component
@SkipComponentScan
class BuildingBlockSupportedProcessLinksHandler : SupportedProcessLinkTypeHandler {
    override fun getProcessLinkType(activityType: String): ProcessLinkType? {
        return if (activityType == ActivityTypeWithEventName.CALL_ACTIVITY_START.value) {
            ProcessLinkType(BuildingBlockProcessLink.PROCESS_LINK_TYPE, true)
        } else {
            null
        }
    }
