...
/** An `addBuildingBlock` entry: the block's document is created empty and filled by [dataMigration] from the owner, and [processMigration] hijacks the owner's running process into it. */
