...
/**
 * Assembles the parts a process definition management response shares: its process links and its
 * BPMN XML. Used by both the case-definition and the (case-unlinked) process-definition management
 * resources so this logic is not duplicated across them.
 */
