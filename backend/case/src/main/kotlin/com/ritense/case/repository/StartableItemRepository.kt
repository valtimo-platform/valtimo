...
interface StartableItemRepository : JpaRepository<StartableItem, StartableItemId> {
    fun findAllByIdCaseDefinitionId(caseDefinitionId: CaseDefinitionId): List<StartableItem>
