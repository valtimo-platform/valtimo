...
/** Reads a [MigrationConditionNode] from the shape of the JSON rather than a type discriminator, so plan files — and rows deployed before grouping existed — stay readable and unchanged. */
