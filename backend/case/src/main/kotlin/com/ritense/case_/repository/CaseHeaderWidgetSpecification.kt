...
class CaseHeaderWidgetSpecification(
    authRequest: AuthorizationRequest<CaseHeaderWidget>,
    permissions: List<Permission>,
    private val queryDialectHelper: QueryDialectHelper
) : AuthorizationSpecification<CaseHeaderWidget>(authRequest, permissions) {

    override fun toPredicate(
        root: Root<CaseHeaderWidget>,
        query: AbstractQuery<*>,
