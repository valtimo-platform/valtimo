...
class MapCaseWidgetMapper : CaseWidgetMapper<MapCaseWidget, MapCaseWidgetDto> {

    override fun toDto(entity: MapCaseWidget) = MapCaseWidgetDto(
        key = entity.id.key,
        title = entity.title,
        icon = entity.icon,
        width = entity.width,
    ...
    override fun toEntity(dto: MapCaseWidgetDto, index: Int) = MapCaseWidget(
