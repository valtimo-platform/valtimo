...
/** The `dataMigration` component of a plan, owned by the `case` module and stored independently of the plan skeleton. */
@Entity
...
data class DataMigrationConfiguration(
    ...
    val patches: List<DataMigrationPatch> = emptyList(),
)
