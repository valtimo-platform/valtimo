...
/** A plan and its current run status for the admin UI. [triggers], [conditions] and [dryRun] are case-plan only and omitted for a building block plan, which has none of them. */
