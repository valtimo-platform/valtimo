...
class ProgressCaseWidgetMapper : CaseWidgetMapper<ProgressCaseWidget, ProgressCaseWidgetDto> {

    override fun toDto(entity: ProgressCaseWidget) = ProgressCaseWidgetDto(
        key = entity.id.key,
        title = entity.title,
        icon = entity.icon,
        color = entity.color,
    ...
    override fun toEntity(dto: ProgressCaseWidgetDto, index: Int) = ProgressCaseWidget(
