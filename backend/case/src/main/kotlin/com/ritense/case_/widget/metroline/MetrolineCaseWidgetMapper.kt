...
class MetrolineCaseWidgetMapper : CaseWidgetMapper<MetrolineCaseWidget, MetrolineCaseWidgetDto> {

    override fun toDto(entity: MetrolineCaseWidget) = MetrolineCaseWidgetDto(
        key = entity.id.key,
        title = entity.title,
        icon = entity.icon,
        color = entity.color,
    ...
    override fun toEntity(dto: MetrolineCaseWidgetDto, index: Int) = MetrolineCaseWidget(
