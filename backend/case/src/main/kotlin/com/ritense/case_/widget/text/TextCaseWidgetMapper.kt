...
class TextCaseWidgetMapper : CaseWidgetMapper<TextCaseWidget, TextCaseWidgetDto> {
    override fun toDto(entity: TextCaseWidget) = TextCaseWidgetDto(
        key = entity.id.key,
        title = entity.title,
        icon = entity.icon,
        color = entity.color,
    ...
    override fun toEntity(dto: TextCaseWidgetDto, index: Int) = TextCaseWidget(
