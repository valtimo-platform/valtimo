...
class PersonCardCaseWidgetMapper : CaseWidgetMapper<PersonCardCaseWidget, PersonCardCaseWidgetDto> {

    override fun toDto(entity: PersonCardCaseWidget) = PersonCardCaseWidgetDto(
        key = entity.id.key,
        title = entity.title,
        icon = entity.icon,
        color = entity.color,
    ...
    override fun toEntity(dto: PersonCardCaseWidgetDto, index: Int) = PersonCardCaseWidget(
