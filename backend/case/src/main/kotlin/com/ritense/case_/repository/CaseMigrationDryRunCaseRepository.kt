...
interface CaseMigrationDryRunCaseRepository : JpaRepository<CaseMigrationDryRunCase, CaseMigrationCaseId> {

    fun countByIdMigrationIdAndStatus(migrationId: BlueprintMigrationId, status: DryRunCaseStatus): Long
