...
public class JsonSchemaDocumentInspectionEditedEvent extends AuditMetaData implements AuditEvent {
    ...
    @JsonCreator
    public JsonSchemaDocumentInspectionEditedEvent(
        UUID id,
        String origin,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JsonSchemaDocumentInspectionEditedEvent that)) {
            return false;
        }
        if (!super.equals(o)) {
            return false;
        ...
        return Objects.equals(documentId, that.documentId)
            && Objects.equals(previousContent, that.previousContent)
