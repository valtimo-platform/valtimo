...
public class DocumentRetentionPeriodSetEvent extends AuditMetaData
    ...
    @JsonCreator
    public DocumentRetentionPeriodSetEvent(
        UUID id,
        String origin,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DocumentRetentionPeriodSetEvent)) {
            return false;
        }
        if (!super.equals(o)) {
            return false;
        ...
        DocumentRetentionPeriodSetEvent that = (DocumentRetentionPeriodSetEvent) o;
        return Objects.equals(retentionDate, that.retentionDate)
