...
package com.ritense.logging.endpoint
...
@SkipComponentScan
class LoggingEndpointDescriptionProvider : EndpointDescriptionProvider {

    override fun getEndpointDescriptors(): List<EndpointDescriptor> = listOf(
        endpoint("POST", "/api/management/v1/logging", "Search log entries", "Logregels zoeken"),
    )
