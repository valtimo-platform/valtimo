...
fun main(args: Array<String>) {
    ...
    val caseTabService = applicationContext.getBean(CaseTabService::class.java)
    ...
    val demoDataService = applicationContext.getBean(DemoDataService::class.java)
    demoDataService.deployDocuments()
}