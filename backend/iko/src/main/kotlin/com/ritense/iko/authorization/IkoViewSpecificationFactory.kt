...
class IkoViewSpecificationFactory(
    private val ikoViewRepository: IkoViewRepository,
    private var queryDialectHelper: QueryDialectHelper,
) : AuthorizationSpecificationFactory<IkoView> {

    override fun create(
        request: AuthorizationRequest<IkoView>,
        permissions: List<Permission>
    ): AuthorizationSpecification<IkoView> {
        return IkoViewSpecification(
            request,
            permissions,
            ikoViewRepository,
            queryDialectHelper
    ...
    override fun canCreate(context: AuthorizationRequest<*>, permissions: List<Permission>): Boolean {
        return IkoView::class.java == context.resourceType
    }
}
