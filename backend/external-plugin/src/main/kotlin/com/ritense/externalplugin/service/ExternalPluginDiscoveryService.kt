...
class ExternalPluginDiscoveryService(
    ...
    private fun pollHost(host: ExternalPluginHost): HostDiscoveryResult {
        ...
        try {
            ...
            // Short transaction: upsert discovered definitions and mark missing ones. Both
            // collections are declared outside the lambda: they are the poll's result, read again
