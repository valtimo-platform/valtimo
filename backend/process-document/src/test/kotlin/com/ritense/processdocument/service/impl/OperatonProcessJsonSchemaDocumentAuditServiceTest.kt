...
class OperatonProcessJsonSchemaDocumentAuditServiceTest {

    private lateinit var auditService: AuditService
    private lateinit var documentService: JsonSchemaDocumentService
    private lateinit var authorizationService: AuthorizationService

    private lateinit var service: OperatonProcessJsonSchemaDocumentAuditService
    ...
    fun setUp() {
        ...
        service = OperatonProcessJsonSchemaDocumentAuditService(
            auditService,
            documentService,
