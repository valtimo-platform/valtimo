...
/** Resolves a case definition version's process definitions via the case ↔ process-definition link. */
class CaseProcessDefinitionBlueprintResolver(
    ...
    override fun resolveProcessDefinitions(blueprintId: BlueprintId): Map<String, String> =
        processDefinitionCaseDefinitionRepository.findByIdCaseDefinitionId(blueprintId as CaseDefinitionId)
